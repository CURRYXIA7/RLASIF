...
for pdb_id in pdb_ids:
    ...
    if number >= 1:
        ...
        try:
            vertices1, faces1, normals1, names1, areas1  = computeMSMS(protonated_file, protonate=True, Mg=None, pdb_id=pdb_id)
        except:
        ...
        save_ply(out_Ply_files + ".ply", regular_mesh.vertices, \
                 regular_mesh.faces, normals=vertex_normal, iface=iface, charges=vertex_charges)
